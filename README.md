<p align="center">
  <img src="assets/banner.svg" alt="Awesome Multi-Echelon Inventory Optimization Banner" width="100%" />
</p>
...
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/ishandutta2007/Awesome-Multi-Echelon-Inventory-Optimization/pulls)
...
| **[Multi-Agent DRL on Multi-Echelon Inventory](https://github.com/xiaotianliu01/Multi-Agent-Deep-Reinforcement-Learning-on-Multi-Echelon-Inventory-Management)** | [![MADRL MEIO Stars](https://img.shields.io/github/stars/xiaotianliu01/Multi-Agent-Deep-Reinforcement-Learning-on-Multi-Echelon-Inventory-Management?style=social&color=white)](https://github.com/xiaotianliu01/Multi-Agent-Deep-Reinforcement-Learning-on-Multi-Echelon-Inventory-Management/stargazers) | Multi-Agent Deep Reinforcement Learning (MADRL) framework to mitigate bullwhip effects and minimize total holding/penalty costs in multi-echelon supply networks. | `Python` • `PyTorch` • `Ray RLlib` |
| **[Cortana Intelligence MEIO](https://github.com/Azure/cortana-intelligence-inventory-optimization)** | [![Azure MEIO Stars](https://img.shields.io/github/stars/Azure/cortana-intelligence-inventory-optimization?style=social&color=white)](https://github.com/Azure/cortana-intelligence-inventory-optimization/stargazers) | Cloud-scale reference architecture for multi-echelon safety stock optimization using PySpark and distributed mathematical solvers across thousands of retail SKUs. | `Python` • `PySpark` • `Azure` |
| **[SupplyChainv0 Gym Environment](https://github.com/kishorkukreja/SupplyChainv0_gym)** | [![SupplyChainv0 Stars](https://img.shields.io/github/stars/kishorkukreja/SupplyChainv0_gym?style=social&color=white)](https://github.com/kishorkukreja/SupplyChainv0_gym/stargazers) | OpenAI Gym compatible environment simulating linear and divergent multi-echelon supply chains for testing RL replenishment agents. | `Python` • `OpenAI Gym` |
| **[InventoryOptimizer](https://github.com/saru2020/InventoryOptimizer)** | [![InventoryOptimizer Stars](https://img.shields.io/github/stars/saru2020/InventoryOptimizer?style=social&color=white)](https://github.com/saru2020/InventoryOptimizer/stargazers) | End-to-end containerized web application for SKU demand forecasting, ABC/XYZ classification, and multi-location safety stock calculation. | `Python` • `Docker` • `Streamlit` |
| **[Multi-Echelon RL Inventory](https://github.com/singhdivyank/multi-echelon-rl-inventory)** | [![RL Inventory Stars](https://img.shields.io/github/stars/singhdivyank/multi-echelon-rl-inventory?style=social&color=white)](https://github.com/singhdivyank/multi-echelon-rl-inventory/stargazers) | Deep RL implementations (A3C, PPO) comparing neural control policies against classical (s, S) inventory control heuristics across multi-stage logistics pipelines. | `Python` • `TensorFlow` |
| **[LP Multi-Echelon Inventory Optimization](https://github.com/shashboy/Multi_Echelon_Inventory_Optimization)** | [![LP MEIO Stars](https://img.shields.io/github/stars/shashboy/Multi_Echelon_Inventory_Optimization?style=social&color=white)](https://github.com/shashboy/Multi_Echelon_Inventory_Optimization/stargazers) | Linear Programming (LP) and Mixed-Integer Linear Programming (MILP) formulations (using PuLP) for finished-goods inventory positioning. | `Python` • `PuLP` |
...
[![Star History Chart](https://star-history.dera.page/svg?repos=ishandutta2007/Awesome-Multi-Echelon-Inventory-Optimization&type=date&legend=top-left)](https://star-history.dera.page/#ishandutta2007/Awesome-Multi-Echelon-Inventory-Optimization&type=date&legend=top-left)
